...
<svelte:head>
    <title>Arvest | {BCVocab.projects[langVal]}</title>
</svelte:head>
...
<BreadCrumbs
    breadcrumbs={[
        ...
        { text: BCVocab.projects[langVal], href: base + "/" + langVal + "/community/projects" }
      ]}
    />

<div class="cont">
    {#each data.articles as article, index}
    <a class="article_card" href={base}{`/${langVal}/community/projects/${article.slug}`}>
